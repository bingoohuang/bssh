...
func TestCheckTypeError(t *testing.T) {
	...
	tds := []TestData{
		// exit 1 {r: false, l: false, toR: false, countHosts: 0},
		{r: false, l: false, toR: true, countHosts: 0},
		// exit 1 {r: false, l: true, toR: false, countHosts: 0},
		{r: false, l: true, toR: true, countHosts: 0},
		{r: true, l: false, toR: false, countHosts: 0},
		{r: true, l: false, toR: true, countHosts: 0},
		// exit 1 {r: true, l: true, toR: false, countHosts: 0},
